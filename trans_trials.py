...
from google.cloud import translate_v3beta1 as translate # Using v3beta1 for Project ID
...
def transcribe_audio(speech_client: Optional[speech.SpeechClient], audio_bytes: bytes, language_code: str) -> Optional[str]:
    """
    ...
    Args:
        ...
        language_code: The language code of the speech (e.g., 'en', 'hi', 'ta', 'te').
                       Google STT often prefers regional codes for better accuracy.
    ...
    # Add more mappings as needed for languages you support
    ...
    config = speech.RecognitionConfig(
        # st_audiorecorder typically outputs WAV files which use LINEAR16 encoding
        encoding=speech.RecognitionConfig.AudioEncoding.LINEAR16,
        sample_rate_hertz=44100,  # st_audiorecorder's default sample rate
